  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // 🔥 ПРЕМИАЛЬНАЯ ПАЛИТРА ДЛЯ WAITLIST SECTION
        mint: {
          25: '#f0fdf9',
          50: '#ecfdf5',
          100: '#d1fae5',
        ...
        // 🔥 ДОПОЛНИТЕЛЬНЫЕ ПРЕМИАЛЬНЫЕ ЦВЕТА
        platinum: {
          50: '#f8fafc',
          100: '#f1f5f9',
          200: '#e2e8f0',
      ...
      // 🔥 ЛЮКСОВЫЕ АНИМАЦИИ ДЛЯ ПЛАВНЫХ ПЕРЕХОДОВ
      keyframes: {
        "accordion-down": {
          from: {
            height: "0",
        ...
        // 🔥 ПЛАВНЫЕ АНИМАЦИИ ДЛЯ ПРЕМИАЛЬНОГО ВИДА
        "luxury-fade-in": {
          "0%": {
            opacity: "0",
      ...
      // 🔥 ДОПОЛНИТЕЛЬНЫЕ НАСТРОЙКИ ДЛЯ ПРЕМИАЛЬНОГО ВИДА
      backdropBlur: {
        xs: '2px',
      },
      boxShadow: {
